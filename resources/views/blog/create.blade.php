    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="text" name="heading" class="form-control tinymce-editor" placeholder="Heading">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control tinymce-editor" style="height:150px" name="body"
