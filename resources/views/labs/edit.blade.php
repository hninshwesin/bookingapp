        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" style="height:150px" name="address"
                    placeholder="Address">{{ $lab->address }}</textarea>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="available_time"
                    placeholder="$lab->available_time">{{ $lab->available_time }}</textarea>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="comment"
                    placeholder="Write down your comment">{{ $lab->comment }}</textarea>
