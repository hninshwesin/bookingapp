        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="contact_number" placeholder="Contact Number" value="{{ $pharmacy->contact_number }}">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="available_time" placeholder="$pharmacy->available_time">{{ $pharmacy->available_time }}</textarea>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="comment" placeholder="Write down your comment">{{ $pharmacy->comment }}</textarea>
